                        ...
                        <div className="col-md-12 text-center" style={{ paddingTop: "50px" }}>
                            <div className="site-footer-widget mb-4">
                                <ul className="site-footer-social list-unstyled ">
                                    <li className="site-animate"><a href="#"><span className="icon-twitter"></span></a></li>
                                    <li className="site-animate"><a href="#"><span className="icon-facebook"></span></a></li>
                                    <li className="site-animate"><a href="#"><span className="icon-instagram"></span></a></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-md-12 text-center">
                            <p>
                                Copyright &copy; 2019 | All rights reserved | This website is made with the help of <a href="https://colorlib.com" target="_blank">
                                    Colorlib
                                </a>
                            </p>
                        </div>
